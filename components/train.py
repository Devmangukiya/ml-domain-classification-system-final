...
def train_model(
    ...
    train_loop_config: Annotated[Path, typer.Option(help="path to training config json")] = None,
    ...
    print("RAW train_loop_config:", train_loop_config)
    # Set up
    with open(train_loop_config, "r") as f:
        train_loop_config = json.load(f)
